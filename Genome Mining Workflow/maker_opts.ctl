...
repeat_protein=/home/people/ghughes/maker/data/te_proteins.fasta #provide a fasta file of transposable element proteins for RepeatRunner
...
pred_flank=10 #flank for extending evidence clusters sent to gene predictors
...
single_length=6 #min length required for single exon ESTs if 'single_exon is enabled'
